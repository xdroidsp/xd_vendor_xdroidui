...
# xd. Bootanimation
ifeq ($(XDROID_BOOT),)
$(warning "xdroidUI: Happy 77th Indonesian Independence Day")
    PRODUCT_COPY_FILES += $(XDUI_PATH)/bootanimation/xd_boot-77_720_legacy.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
else
ifeq ($(XDROID_BOOT),480)
$(warning "xdroidUI: Happy 77th Indonesian Independence Day 480p")
    PRODUCT_COPY_FILES += $(XDUI_PATH)/bootanimation/xd_boot-77_480.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
endif
ifeq ($(XDROID_BOOT),720)
$(warning "xdroidUI: Happy 77th Indonesian Independence Day 720p")
    PRODUCT_COPY_FILES += $(XDUI_PATH)/bootanimation/xd_boot-77_720.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
endif
ifeq ($(XDROID_BOOT),1080)
$(warning "xdroidUI: Happy 77th Indonesian Independence Day 1080p")
    PRODUCT_COPY_FILES += $(XDUI_PATH)/bootanimation/xd_boot-77_1080.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
endif
ifeq ($(XDROID_BOOT),1440)
$(warning "xdroidUI: Happy 77th Indonesian Independence Day 1440p")
    PRODUCT_COPY_FILES += $(XDUI_PATH)/bootanimation/xd_boot-77_1440.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
endif
endif
